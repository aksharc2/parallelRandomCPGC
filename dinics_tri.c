...
int main(int argc, char* argv[]) {
	...
	delta = atof(argv[4]);
	char *algo = argv[5];
        sprintf(filename, "/ocean/projects/cis230093p/achavan/graphCompression/compressedGraph/compressed_graph_%d_%d_%d_%.1f.mtx", nodes, density, exp, delta);
        //sprintf(filename, "data3_1/tripartite_graph_%d_%d_%d.mtx", nodes, density, exp); compressed_graph_32768_98_1_1.0.mtx
    }
